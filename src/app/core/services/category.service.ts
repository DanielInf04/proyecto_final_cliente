...
export class CategoryService {
  ...
  public createCategory(category:any): Observable<HttpResponse<Icategory>> {
    ...
    return this._http.post<Icategory>(`${this.apiUrl}api/category`, category, {
      headers: {
  ...
  public editCategory(id: any, datos: any): Observable<HttpResponse<Icategory>> {
    ...
    return this._http.post<Icategory>(`${this.apiUrl}api/category/${id}`, datos, {
      headers: {
        Authorization: `Bearer ${token}`
      },
      observe: 'response'
  ...
  public deleteCategory(id: any): Observable<HttpResponse<Icategory>> {
    ...
    return this._http.delete<Icategory>(`${this.apiUrl}api/category/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`
      },
      observe: 'response'
